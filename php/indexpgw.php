...
<div class="row no-gutters mt-5">
  ...
  <div class="col-md-10 p-5 pt-2">
    <h3><i class="fas fa-user-graduate mr-2"></i> Daftar Pegawai</h3><hr>
        <a href="tambah_pgw.php" class="btn btn-primary mb-2" data-toggle="modal" data-target="#tambahpgw"> 
        ...
        <?php
          include "koneksipgw.php";
              ...
              $query = mysqli_query($koneksipgw, "SELECT * FROM pegawai");
              $no = 1;
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="update_pgw.php" method="post" role="form">
                        <?php
                        $nik = $data['nik'];
                        $query1 = mysqli_query($koneksipgw, "SELECT * FROM pegawai WHERE nik='$nik'");
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="nik" value="<?php echo $data1['nik']; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="bagian" value="<?php echo $data1['bagian']; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div id="deletepgw<?php echo $data['nik']; ?>" class="modal fade" role="dialog" style="display:none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5 align="center">Apakah Anda yakin ingin menghapus NIK <?php echo $data['nik']; ?> ?</h5>
                </div>
                <div class="modal-footer">
                    <button id="nodelete" type="button" class="btn btn-danger pull-left" data-dismiss="modal">Batal</button>
                    <a href="hapus_pgw.php?nik=<?php echo $data['nik']; ?>" class="btn btn-primary">Hapus</a>
                </div>
            </div>
        </div>
    </div>
          ...
          <form action="simpan_pgw.php" method="post" role="form">
            ...
            <div class="form-group">
              <div class="row">
                <label class="col-sm-3 control-label text-right">Nama Pegawai</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="nama" placeholder="Nama Pegawai" value="">
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="row">
                <label class="col-sm-3 control-label text-right">Bagian</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="bagian" placeholder="bagian" id="bagian" value="">
                </div>
              </div>
            </div>
            <div class="modal-footer">

...
$nidn = $_GET['nidn'];
$result = mysqli_query($koneksidsn, "SELECT * FROM dosen WHERE nidn='$nidn'"); while($user_data = mysqli_fetch_array($result))
{
$nama = $user_data['nama'];
...
<a class="nav-link text-white" href="jadwal.php" ><i class="far fa-calendar-alt mr-2"></i>Jadwal Kuliah</a><hr class="bg-secondary">
            ...
            <div class="col-md-10 p-5 pt-2">
                <h3><i class="fas fa-user-graduate mr-2"></i> Ubah Data Dosen</h3><hr>
